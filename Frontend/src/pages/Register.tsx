    ...
    <div className="relative flex justify-center items-center min-h-screen bg-linear-to-b from-[#005fbf] to-white text-white z-99">
      ...
      <div className="flex flex-col justify-center items-center border-2 p-4 gap-y-4 w-1/2">
        ...
        <div className="flex flex-col gap-y-4 w-1/2">
          ...
          <input
            placeholder="Email"
            className="border-2 text-black p-2 bg-white"
          ...
          <div className="relative w-full">
            ...
            <span
              ...
              className="absolute bg-white w-fit p-1 rounded-2xl right-0 top-1/2 -translate-y-1/2 cursor-pointer text-black select-none"
            >
              {passwordVisible ? (
                <svg
          ...
          <div className="relative w-full">
            ...
            />
            <span
              onClick={passConfirmToggle}
              className="absolute bg-white border-black w-fit p-1 rounded-2xl right-0 top-1/2 -translate-y-1/2 cursor-pointer text-black select-none"
            >
              {passConfirmVisible ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
